 ...
 * wake lock.
 */
public class SampleSchedulingService extends IntentService implements MainMvp.PingMvp{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        presenter.ping(Preferences.with(getApplicationContext()).getUrl());
...
//
    ...
    public void onSuccess(String message) {
        ...
        Preferences.with(getApplicationContext()).setLog(message).save();
